...
/**
 * @since         1.5.3
 * @template-implements \IteratorAggregate<int, Fitting>
 * Represents a collection of event table items, extending the functionality of the ArrayObject class.
 */
class FittingsCollection extends \ArrayObject implements CollectionInterface
{
	use ItemsTrait;
	...
	public function __construct(array|null $items = [])
	{
		...
		{
			$this->items[] = Fitting::createFromObject($item);
		}
	}
}
