...
/**
 * @since         1.5.3
 * @template-implements \IteratorAggregate<int, AttendingTableItem>
 * Represents a collection of event table items, extending the functionality of the ArrayObject class.
 */
class AttendingTableItemsCollection extends \ArrayObject implements CollectionInterface
{
	use ItemsTrait;
	...
	public function __construct(array $items = null)
	{
		...
		{
			$this->items[] = AttendingTableItem::createFromObject($item);
		}
	}
}
