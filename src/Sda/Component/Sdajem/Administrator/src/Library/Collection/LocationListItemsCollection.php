...
use Sda\Component\Sdajem\Administrator\Library\Item\LocationListItem;
use Sda\Component\Sdajem\Administrator\Library\Trait\ItemsTrait;

/**
 * @since         1.5.3
 * @template-implements \IteratorAggregate<int, LocationListItem>
 * Represents a collection of event table items, extending the functionality of the ArrayObject class.
 */
class LocationListItemsCollection extends \ArrayObject implements CollectionInterface
{
	use ItemsTrait;
	...
	public function __construct(array $items = null)
	{
		...
		{
			$this->items[] = LocationListItem::createFromObject($item);
		}
	}
}
