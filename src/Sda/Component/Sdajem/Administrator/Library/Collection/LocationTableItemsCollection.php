...
/**
 * @since         1.5.3
 * @template-implements \IteratorAggregate<int, LocationTableItem>
 * Represents a collection of event table items, extending the functionality of the ArrayObject class.
 */
class LocationTableItemsCollection extends \ArrayObject implements CollectionInterface
{
	use ItemsTrait;
	...
	public function __construct(array $items = null)
	{
		...
		{
			$this->items[] = LocationTableItem::createFromObject($item);
		}
	}
}
