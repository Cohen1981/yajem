...
/**
 * @package     Joomla.Site
 * @subpackage  Templates.survivants
 *
...
$wa->registerAndUseStyle($assetColorName, 'media/templates/site/survivants/css/global/' . $paramsColorName . '.css');
...
// Enable assets
$wa->usePreset('template.survivants.' . ($this->direction === 'rtl' ? 'rtl' : 'ltr'))
...
<div class="sda_header container-header full-width">
    ...
    <?php if ($this->params->get('backTop') == 1) : ?>
        <a href="#top" id="back-top" class="back-to-top-link" aria-label="<?php echo Text::_('TPL_SURVIVANTS_BACKTOTOP'); ?>">
