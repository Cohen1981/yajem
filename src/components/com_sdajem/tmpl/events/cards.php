							...
							if (!$currentUser->guest) :
								...
								<div class="col-auto align-content-center">
									...
									if ($currentUser->id == $event->organizerId || $canDo->get('core.manage')) :
										...
										<div class="row pb-1">
											...
											echo $class; ?> dropdown-toggle" data-bs-toggle="dropdown"
													aria-expanded="false">
												<?php
												echo Text::_($event->eventStatus->getStatusLabel()); ?>
											</button>
									...
									<?php
										...
										<div class="row">
											<?php
											echo $event->eventStatus->getStatusBadge(); ?>
										</div>
									<?php
									endif; ?>
								...
								if ($event->registerUntil) :
									...
									<div class="col-11">
										...
										if ($event->organizerName) :
											?>
											<br><?php
											echo Text::_('COM_SDAJEM_ORGANIZIG') . ': ' . $event->organizerName ?>
										<?php
										endif ?>
									</div>
								<?php
