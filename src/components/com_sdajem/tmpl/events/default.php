						...
						<?php
							...
							<table class="table table-striped" id="eventList">
								...
								foreach ($this->items as $i => $item) : ?>
									<?php
									if ($item->eventStatus == EventStatusEnum::CONFIRMED->value || in_array(
										...
										echo $i % 2; ?>">
											...
											<th scope="row" class="has-context col-4">
												...
												if ($params->get('sda_use_attending') && !$currentUser->guest) : ?>
													...
													<?php
													$attStatus = (Attending::getAttendingToEvent(
															$currentUser->id,
															$item->id
													));
													?>
											...
											if (!$currentUser->guest) : ?>
												<td class="d-sm-table-cell d-none">
													...
													if ($currentUser->id == $item->organizerId || $canDo->get(
														...
														<div class="sda_form">
															...
															echo $class; ?> dropdown-toggle" data-bs-toggle="dropdown"
																	aria-expanded="false">
																<?php
																echo Text::_($item->eventStatus->getStatusLabel()); ?>
															</button>
													...
													<?php
														...
														<div>
															<?php
															echo $item->eventStatus->getStatusBadge(); ?>
														</div>
													<?php
													endif; ?>
												</td>
