...
namespace Sda\Component\Sdajem\Site\View\Attending;
...
class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null)
	{
		...
		if ((!$active) || ((strpos($active->link, 'view=attending') === false) || (strpos($active->link, '&id=' . (string) $this->item->id) === false))) {
			if (($layout = $item->params->get('attendings_layout'))) {
