CREATE TABLE IF NOT EXISTS `#__yajem_locations` (
  `yajem_location_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `#__yajem_events` (
  `yajem_event_id` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Id of the Event',
...
CREATE TABLE IF NOT EXISTS `#__yajem_attendees` (
  `yajem_attendee_id` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
CREATE TABLE IF NOT EXISTS `#__yajem_comments` (
  `yajem_comment_id` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `userId` INT UNSIGNED NOT NULL COMMENT 'Foreign Key to #__users',
  `eventId` INT UNSIGNED NOT NULL COMMENT 'Foreign Key to #__yajame_events',
  `comment` MEDIUMTEXT NOT NULL ,
  `timestamp` DATETIME,
  PRIMARY KEY (`yajem_comment_id`),
...
(
  `yajem_attachment_id` int unsigned auto_increment comment 'Primary Key',
  ...
  PRIMARY KEY (`yajem_attachment_id`),
...
CREATE TABLE IF NOT EXISTS `#__yajem_fittings`
(
  `yajem_fitting_id` int unsigned auto_increment comment 'Primary Key',
  `userId` int unsigned not null,
  `type` varchar(255) null,
  `detail` varchar(255) null,
  `lenght` int null,
  `width` int null,
  PRIMARY KEY (`yajem_fitting_id`)
)
  ENGINE=InnoDB
  DEFAULT CHARSET=`utf8mb4` DEFAULT COLLATE=`utf8mb4_unicode_ci`;