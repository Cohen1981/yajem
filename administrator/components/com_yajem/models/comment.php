 ...
 * @since       1.2
 */
class YajemModelComment extends AdminModel
{
	/**
	...
	/**
	 * @var null Holds the single Comment
	 * @since 1.2
	 */
	protected $item = null;
	 ...
	 * @throws Exception
	 */
	public function getTable($name = 'Comment', $prefix = 'YajemTable', $options = array())
	{
	...
	{
		$form = $this->loadForm('com_yajem.attachment', 'attachment',
			array('control' => 'jform',
				'load_data' => $loadData
			)
		);
	...
	{
		$data = Factory::getApplication()->getUserState('com_yajem.edit.comment.data', array());
