 ...
 * @since       1.1
 */
class YajemModelAttachment extends AdminModel
{
	/**
	 ...
	 * @throws Exception
	 */
	public function getTable($name = 'Attachment', $prefix = 'YajemTable', $options = array())
	{
 ...
 */
	...
	{
		$data = Factory::getApplication()->getUserState('com_yajem.edit.attachment.data', array());
